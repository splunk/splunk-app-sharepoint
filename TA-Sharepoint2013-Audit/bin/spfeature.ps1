...
$SaveFile = "SPFeature.xml"

$State = Import-LocalStorage $SaveFile -DefaultValue (New-Object PSObject -Property @{ Objects = @{} })

$List = Get-SPFeature -Limit All | `
| Select-Object @{n="Type";e={"FeatureDefinition"}}, `
			    @{n="FarmId";e={$FarmId}}, `
				Id, Name, DisplayName, Status, Version, `
				ActivateOnDefault, AlwaysForceInstall, `
				AutoActivateInCentralAdmin, Hidden, 
				ReceiverAssembly, ReceiverClass, RequireResources, `
				RootDirectory, Scope, SolutionId, UIVersion 
